  ...
  return (
    <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-6 mx-auto max-w-4xl">
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="text-sm font-semibold text-gray-700">Demo Telemetri Langsung</span>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs uppercase text-gray-500">Suhu</span>
          </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs uppercase text-gray-500">Level Air</span>
          </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs uppercase text-gray-500">Durasi</span>
          </div>
          <div className="text-xl font-black text-gray-900">18 jam</div>
          <div className="text-xs text-gray-400 mt-1">dari 48 jam</div>
        </div>
      </div>
    </section>
  );
